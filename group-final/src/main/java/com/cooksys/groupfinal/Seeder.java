...
public class Seeder implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
	  ...
	  creds13.setUsername("admin");
	  creds13.setPassword("admin");
	  user13.setCredentials(creds13);
	  Profile profile13 = new Profile();
	  profile13.setFirstName("Will");
	  profile13.setLastName("Marttala");
	  profile13.setEmail("will@email.com");
	  ...
	  company1.setEmployees(new HashSet<User>(Arrays.asList(user1, user2, user3, user4, user5, user6, user7, user8, user9, user13)));
	  ...
	  company2.setEmployees(new HashSet<User>(Arrays.asList(user10, user11, user12, user13)));
	  ...
	  team1.setTeammates(new HashSet<User>(Arrays.asList(user1, user2, user13)));
	  ...
	  team3.setTeammates(new HashSet<User>(Arrays.asList(user4, user9, user13)));
	  ...
	  team4.setTeammates(new HashSet<User>(Arrays.asList(user1, user3, user13)));
	  
	  team5.setName("Team 5");
	  team5.setDescription("Logan & Marcia");
	  team5.setCompany(company1);
	  team5.setTeammates(new HashSet<User>(Arrays.asList(user6, user8, user13)));
	  
	  team6.setName("Team 6");
	  team6.setDescription("Kendall, Roman, Shiv, & Connor");
	  team6.setCompany(company1);
	  team6.setTeammates(new HashSet<User>(Arrays.asList(user3, user4, user5, user7, user13)));
	  
	  team7.setName("Team 7");
	  team7.setDescription("Helena, Kenny, & Will");
	  team7.setCompany(company2);
	  team7.setTeammates(new HashSet<User>(Arrays.asList(user10, user11, user12, user13)));
